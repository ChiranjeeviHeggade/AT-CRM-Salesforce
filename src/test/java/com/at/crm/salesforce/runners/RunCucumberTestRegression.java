...
@CucumberOptions(features = "C:/Jenkins/workspace/SFDC/AT-SFDC-Regression/SFDC_Cucumber/src/test/resources/features", glue = { "com.inmarsat.sfdc.stepdefinitions" }, tags = {
		"@Campaign,@Lead" }, monochrome = true, plugin = { "pretty", "pretty:C:/Jenkins/workspace/SFDC/AT-SFDC-Regression/SFDC_Cucumber/target/cucumber-report/Regresssion/pretty.txt",
...
public class RunCucumberTestRegression extends TestBase {
