...
@CucumberOptions(features = "./src/test/resources/features", glue = { "com.at.crm.salesforce.stepdefinitions" }, tags = {
        "@MaritimeCampaignCreation" }, monochrome = true, plugin = { "pretty", "pretty:./target/cucumber-report/Regresssion/pretty.txt",
...
public class RunCucumberTestMaritime extends TestBase {
